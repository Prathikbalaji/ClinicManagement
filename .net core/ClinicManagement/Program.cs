...
builder.Services.AddDbContext<ClinicManagementDBContext>(opt => opt.UseSqlServer(builder.Configuration.GetConnectionString("Payoda")));
builder.Services.AddScoped<IReceptionist, ReceptionistRepository>();
